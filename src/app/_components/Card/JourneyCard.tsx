...
const JourneyCard = ({ date, description, readMore, button, image, title, className }: Omit<CardProps, 'type'>) => {
  return (
    <div className={cn('flex flex-col p-[4.194vw] tablet:p-[2.5vw] desktop:p-[1.04vw] gap-[2.33vw] tablet:gap-[1.875vw] desktop:gap-[1.3vw] rounded-[6.99vw] tablet:rounded-[3.75vw] desktop:rounded-[1.56vw] linear-border-vertical transition-all duration-700 hover:desktop:p-0 group overflow-hidden bg-white ', className)} >
      ...
      <div className=' text-gray-450 flex flex-col justify-between gap-[2.33vw] tablet:gap-[1.25vw] desktop:gap-[1.04vw] h-full  text-[3.262vw] tablet:text-[1.75vw] desktop:text-[0.936vw] '>
        <p>{description}</p>
